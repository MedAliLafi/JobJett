    ...
    <div className="job-offer-details">
      ...
      {jobofferDetails && (
        <div>
          ...
          <p>
            <strong>Required Education:</strong> {jobofferDetails.ReqEducation}
          </p>
          <p>
            <strong>Required Experience:</strong> {jobofferDetails.ReqExperience}
          </p>
          <p>
            <strong>Required Skills:</strong> {jobofferDetails.ReqSkills}
          </p>
          <p>
            <strong>Required Soft Skills:</strong> {jobofferDetails.ReqSoftSkills}
          </p>
        </div>
      )}
