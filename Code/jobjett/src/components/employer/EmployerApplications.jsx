            ...
            try {
                ...
                if (jobOffersResponse.ok) {
                    ...
                    for (const jobOffer of jobOffersData) {
                        const applicationsResponse = await fetch(`http://localhost:9000/Employer/JobOffer/${jobOffer.JobOfferID}/applications`, {
                            credentials: 'include'
                        });
                        if (applicationsResponse.ok) {
                            ...
                            console.error(`Failed to fetch applications for job offer ${jobOffer.JobOfferID}`);
