  ...
  const fetchEmployerInfo = async () => {
    try {
      const response = await fetch(
        "http://localhost:9000/Employer/employerInfo",
        {
          method: "GET",
          headers: {
    ...
    <>
      ...
      <div>
        ...
        {employerInfo && (
          <div>
            <p>
              <strong>Company Name:</strong> {employerInfo.companyName}
            </p>
            <p>
              <strong>Email:</strong> {employerInfo.email}
            </p>
            <p>
              <strong>Industry:</strong> {employerInfo.industry}
            </p>
            <p>
              <strong>Phone:</strong> {employerInfo.phone}
            </p>
            <p>
              <strong>Address:</strong> {employerInfo.address}
            </p>
            <p>
              <strong>State:</strong> {employerInfo.state}
            </p>
            <p>
              <strong>Country:</strong> {employerInfo.country}
            </p>
          </div>
        )}
        <h3>Actions</h3>
