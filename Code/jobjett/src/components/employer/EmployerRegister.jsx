...
const industryOptions = [
  ...
  { value: "HV5U6", label: "Aerospace & Defense" },
  { value: "SVBZF", label: "Agriculture" },
  { value: "N322U", label: "Arts, Entertainment & Recreation" },
  { value: "NTW8X", label: "Construction, Repair & Maintenance Services" },
  { value: "RFWNN", label: "Education" },
  { value: "TAN6J", label: "Energy, Mining & Utilities" },
  { value: "MSQWR", label: "Financial Services" },
  { value: "B23RH", label: "Government & Public Administration" },
  { value: "22VKN", label: "Healthcare" },
  { value: "X42V4", label: "Hotels & Travel Accommodation" },
  { value: "Q3FC3", label: "Human Resources & Staffing" },
  { value: "NKR5F", label: "Information Technology" },
  { value: "4EWFJ", label: "Insurance" },
  { value: "6GW2X", label: "Legal" },
  { value: "92AZY", label: "Management & Consulting" },
  { value: "CPGHF", label: "Manufacturing" },
  { value: "4DGEF", label: "Media & Communication" },
  { value: "ZMM32", label: "Nonprofit & NGO" },
  { value: "ZYCW4", label: "Personal Consumer Services" },
  { value: "5ZM33", label: "Pharmaceutical & Biotechnology" },
  { value: "S7KHR", label: "Real Estate" },
  { value: "W2F4E", label: "Restaurants & Food Service" },
  { value: "48BZP", label: "Retail & Wholesale" },
  { value: "JGU5R", label: "Telecommunications" },
  { value: "P634J", label: "Transportation & Logistics" }
];
          ...
          <div className="form-box ">
            ...
            <form onSubmit={registerEmployer} id="employerRegistrationForm">
              ...
              <div className="btn-group flex justify-between">
                ...
                <br></br><p>Already Registered? <Link to="/employer/login">Login here</Link></p>
              </div>
            </form>
          </div>
        </div>
